...
namespace LaVictoireDesServicesHelpDeskApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.comptes = db.Comptes.ToList();
            return View("Index");
        }
        ...
        public IActionResult Modifier(int id,CompteViewModel compteViewModel)
        {
            try
            {
                ...
                {
                    password = BCrypt.Net.BCrypt.HashPassword(compteViewModel.Compte.Password, BCrypt.Net.BCrypt.GenerateSalt());
                }
                compteViewModel.Compte.Password = password; 
                db.Entry(compteViewModel.Compte).State = EntityState.Detached;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            catch
        ...
        public IActionResult Profile(Compte compte)
        {
            ...
            try
            {
                ...
                {
                    currentCompte.Password = BCrypt.Net.BCrypt.HashPassword(compte.Password, BCrypt.Net.BCrypt.GenerateSalt());
                }
